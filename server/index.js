...
// ── Timesheets Level 2 contexts ───────────────────────────────────────────────

const ctxEM = {
  title: 'Crew Timesheet — Maya Chen',
  subtitle: 'Week ending 18 July. Hourly rate: $54.00.',
  tables: [{ headers: ['Day', 'Start', 'Finish', 'Non-Billable'], rows: [
    ['Mon', '6:45 am', '3:30 pm', '45 min'],
    ['Tue', '7:00 am', '4:15 pm', '30 min'],
    ['Wed', '6:30 am', '2:45 pm', '45 min'],
    ['Thu', '7:15 am', '3:00 pm', '30 min'],
    ['Fri', '6:45 am', '3:15 pm', '45 min'],
  ]}]
}
const ctxEN = {
  title: 'Crew Timesheet — Jordan Walsh',
  subtitle: 'Mon–Wed: Site A at $58.00/hr. Thu–Fri: Site B at $63.00/hr.',
  tables: [{ headers: ['Day', 'Billable Hours', 'Rate'], rows: [
    ['Mon', '8.00 h', '$58.00/hr'],
    ['Tue', '7.50 h', '$58.00/hr'],
    ['Wed', '8.25 h', '$58.00/hr'],
    ['Thu', '8.00 h', '$63.00/hr'],
...
const ctxEO = {
  title: 'Crew Timesheet — Casey Tran',
  subtitle: 'Standard rate: $52.00/hr. Overtime rate: 1.5× standard for any hours worked above 8 per day.',
  tables: [{ headers: ['Day', 'Hours Worked'], rows: [
    ['Mon', '10.0 h'], ['Tue', '8.0 h'], ['Wed', '9.5 h'], ['Thu', '8.0 h'], ['Fri', '10.0 h'],
  ]}]
}
const ctxEP = {
  title: 'Crew Timesheet — Weekly Comparison',
  tables: [{ headers: ['Crew', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Rate'], rows: [
    ['Riley', '8.50 h', '7.75 h', '8.00 h', '8.25 h', '7.50 h', '$56.00/hr'],
    ['Casey', '7.75 h', '8.25 h', '8.50 h', '7.50 h', '8.75 h', '$59.00/hr'],
  ]}]
}
const ctxEQ = {
  title: 'Crew Timesheet — Sam Nguyen',
  subtitle: 'Week ending 1 August. Hourly rate: $61.50.',
  tables: [{ headers: ['Day', 'Start', 'Finish', 'Non-Billable'], rows: [
    ['Mon', '7:00 am', '3:45 pm', '45 min'],
    ['Tue', '6:30 am', '4:00 pm', '60 min'],
    ['Wed', '7:15 am', '2:30 pm', '30 min'],
    ['Thu', '6:45 am', '3:30 pm', '45 min'],
    ['Fri', '7:00 am', '4:15 pm', '60 min'],
  ]}]
}
const ctxER = {
  title: 'Crew Timesheet — Three Crew Weekly Summary',
  subtitle: 'Crew cost rate: $57.00/hr. Client billing rate: $85.00/hr.',
  tables: [{ headers: ['Crew Member', 'Total Billable Hours'], rows: [
    ['Alex', '38.50 h'], ['Blair', '41.25 h'], ['Cameron', '39.75 h'],
  ]}]
}
const ctxES = {
  title: 'Crew Timesheet — Taylor Brooks',
  subtitle: 'Standard work week: 40 hours. Hourly rate: $59.50.',
  tables: [{ headers: ['Day', 'Billable Hours'], rows: [
    ['Mon', '7.75 h'], ['Tue', '8.00 h'], ['Wed', '7.25 h'], ['Thu', '8.25 h'], ['Fri', '5.25 h'],
  ]}]
}
const ctxET = {
  title: 'Crew Timesheet — Morgan Lee',
  subtitle: '4-day compressed roster. Hourly rate: $56.00.',
  tables: [{ headers: ['Day', 'Start', 'Finish', 'Non-Billable'], rows: [
    ['Mon', '6:00 am', '5:30 pm', '60 min'],
    ['Tue', '6:15 am', '5:45 pm', '60 min'],
    ['Wed', '5:45 am', '5:15 pm', '75 min'],
    ['Thu', '6:30 am', '5:00 pm', '60 min'],
  ]}]
}
const ctxEU = {
  title: 'Crew Timesheet — Fortnightly Summary',
  tables: [{ headers: ['Crew', 'Week 1 Hours', 'Week 2 Hours', 'Rate'], rows: [
    ['Avery', '39.25 h', '41.50 h', '$54.00/hr'],
    ['Blake', '38.00 h', '40.25 h', '$57.00/hr'],
  ]}]
}
const ctxEV = {
  title: 'Client Billing — Tiered Structure Comparison',
  subtitle: 'Crew worked 42.5 hours this week.',
  tables: [{ headers: ['Structure', 'Rate'], rows: [
    ['A — Flat rate', '$72.00/hr for all hours'],
    ['B — Tiered', '$65.00/hr for first 35 h, then $95.00/hr'],
  ]}]
}

// ── Pay Gap Level 2 contexts ──────────────────────────────────────────────────

const ctxFG = {
  title: 'Gender Pay Gap — Company Wage Data',
  tables: [{ headers: ['Gender', 'Employees', 'Total Annual Wages'], rows: [
    ['Female', '45', '$3,645,000'], ['Male', '38', '$3,344,000'],
  ]}]
}
const ctxFH = {
  title: 'Gender Pay Gap — Cost to Close the Gap',
  tables: [{ headers: ['', 'Average Annual Salary', 'Headcount'], rows: [
    ['Female', '$74,500', '28'], ['Male', '$82,000', '22'],
  ]}]
}
const ctxFI = {
  title: 'Gender Pay Gap — Year-on-Year Change',
  tables: [{ headers: ['Year', 'Female Avg Salary', 'Male Avg Salary'], rows: [
    ['2022', '$68,400', '$78,600'], ['2023', '$71,200', '$80,100'],
  ]}]
}
const ctxFJ = {
  title: 'Gender Pay Gap — Three Departments',
  tables: [{ headers: ['Department', 'Female Avg', 'Male Avg', 'Female Headcount'], rows: [
    ['Finance', '$91,200', '$97,600', '14'],
    ['Operations', '$74,800', '$81,400', '23'],
    ['HR', '$68,500', '$72,000', '11'],
  ]}]
}
const ctxFK = {
  title: 'Gender Pay Gap — Median vs Mean Analysis',
  subtitle: 'Ten female employees\' annual salaries listed in ascending order.',
  tables: [{ headers: ['#', 'Annual Salary'], rows: [
    ['1','$52,000'],['2','$54,500'],['3','$58,000'],['4','$61,200'],['5','$63,400'],
    ['6','$63,400'],['7','$67,800'],['8','$72,000'],['9','$76,500'],['10','$91,200'],
  ]}]
}
const ctxFL = {
  title: 'Gender Pay Gap — Gap Elimination Target',
  tables: [{ headers: ['', 'Value'], rows: [
    ['Female average salary', '$76,800'],
    ['Male average salary', '$84,000'],
    ['Female headcount', '32'],
  ]}]
}
const ctxFM = {
  title: 'Gender Pay Gap — Two-Site Weighted Average',
  tables: [{ headers: ['Site', 'Female Employees', 'Female Avg Salary'], rows: [
    ['Melbourne', '22', '$79,500'], ['Sydney', '18', '$83,200'],
  ]}]
}
const ctxFN = {
  title: 'Gender Pay Gap — Pay Rise Required to Hit Target',
  tables: [{ headers: ['', 'Value'], rows: [
    ['Current female avg salary', '$72,000'],
    ['Male avg salary', '$80,000'],
    ['Current gap', '10% of male avg'],
    ['Target gap', '4% of male avg'],
  ]}]
}
const ctxFO = {
  title: 'Gender Pay Gap — Industry Comparison',
  tables: [{ headers: ['Industry', 'Female Avg Salary', 'Male Avg Salary'], rows: [
    ['Construction', '$68,200', '$84,600'], ['Education', '$79,400', '$81,200'],
  ]}]
}
const ctxFP = {
  title: 'Gender Pay Gap — Bonus Gap Analysis',
  subtitle: 'Both male and female employees share the same base salary of $74,000. Annual bonuses differ.',
  tables: [{ headers: ['', 'Annual Bonus', 'Headcount'], rows: [
    ['Female', '$4,200', '35'], ['Male', '$8,600', '35'],
  ]}]
}

// ── Travel & Commute Level 2 contexts ─────────────────────────────────────────

const ctxFQ = {
  title: 'Daily Commute — Multi-Leg Journey',
  tables: [{ headers: ['Leg', 'Mode', 'Duration', 'Cost'], rows: [
    ['Home → station', 'Walk', '12 min', '—'],
    ['Train', 'Metro', '34 min', '$4.80'],
    ['Station → office', 'Tram', '18 min', '$2.50'],
    ['Office walk', 'Walk', '6 min', '—'],
  ]}]
}
const ctxFR = {
  title: 'Commute — Two Route Options',
  tables: [{ headers: ['Route', 'Journey Time (one way)', 'Single-Trip Cost'], rows: [
    ['A — Express train', '52 min', '$8.40'],
    ['B — Bus + walk', '68 min', '$3.20'],
  ]}]
}
const ctxFS = {
  title: 'Daily Commute — Scheduled vs Delayed Journey',
  tables: [{ headers: ['Leg', 'Scheduled', 'Delay Today'], rows: [
    ['Bus to station', '22 min', '+8 min'],
    ['Wait at station', '5 min', '+12 min'],
    ['Train', '41 min', '0 min'],
    ['Walk to work', '9 min', '0 min'],
  ]}]
}
const ctxFT = {
  title: 'Commute — Car vs Train Cost and Time',
  tables: [{ headers: ['Mode', 'One-Way Time', 'Weekly Cost (return, 5 days)'], rows: [
    ['Car', '28 min', '$67.50'], ['Train', '45 min', '$38.00'],
  ]}]
}
const ctxFU = {
  title: 'Commute — Two-Leg Speed Analysis',
  tables: [{ headers: ['Leg', 'Distance', 'Time'], rows: [
    ['Drive to station', '8 km', '18 min'], ['Train', '16 km', '22 min'],
  ]}]
}
const ctxFV = {
  title: 'Commute Time as a Proportion of Working Hours',
  tables: [{ headers: ['Detail', 'Value'], rows: [
    ['One-way commute', '57 min'],
    ['Commute days per week', '5'],
    ['Standard working week', '38 hours'],
  ]}]
}
const ctxFW = {
  title: 'Annual Commute Cost — Location Comparison',
  tables: [{ headers: ['Scenario', 'Daily Return Ticket', 'Working Days/Year'], rows: [
    ['Current home', '$13.60', '230'], ['If moved closer', '$6.80', '230'],
  ]}]
}
const ctxFX = {
  title: 'Daily Commute — Driving Fuel Cost',
  tables: [{ headers: ['Detail', 'Value'], rows: [
    ['One-way distance', '34 km'],
    ['Fuel efficiency', '8.5 L per 100 km'],
    ['Fuel price', '$1.82 per litre'],
  ]}]
}
const ctxFY = {
  title: 'Annual Commute — Work-From-Home Impact',
  tables: [{ headers: ['Detail', 'Value'], rows: [
    ['Office days per week', '3 (WFH 2 days)'],
    ['One-way commute time', '54 min'],
    ['Working weeks per year', '48'],
  ]}]
}
const ctxFZ = {
  title: 'Weekly Commute — Mixed Transport Modes',
  tables: [{ headers: ['Mode', 'Days/Week', 'One-Way Journey Time'], rows: [
    ['Drive (peak)', '3', '22 min'], ['Public transport', '2', '41 min'],
  ]}]
}
...
const questions = [
  ...
  // ── Sets EM–EV: Timesheets Level 2 ──────────────────────────────────────────
  {
    group: 'EM', type: 'number_input', category: 'Number and Algebra',
    context: ctxEM,
    question: 'Calculate Maya\'s total billable hours for the week. (Billable = total shift time minus non-billable time.)',
    answer: '39.25'
  },
  {
    group: 'EM', type: 'number_input', category: 'Number and Algebra',
    context: ctxEM,
    question: 'What is Maya\'s gross pay for the week?',
    answer: '2119.50'
  },
  {
    group: 'EN', type: 'number_input', category: 'Number and Algebra',
    context: ctxEN,
    question: 'What are Jordan\'s total billable hours for Monday to Wednesday?',
    answer: '23.75'
  },
  {
    group: 'EN', type: 'number_input', category: 'Number and Algebra',
    context: ctxEN,
    question: 'What is Jordan\'s total gross pay for the full week?',
    answer: '2369.75'
  },
  {
    group: 'EO', type: 'number_input', category: 'Number and Algebra',
    context: ctxEO,
    question: 'How many overtime hours did Casey work this week? (Overtime = hours above 8 per day.)',
    answer: '5.5'
  },
  {
    group: 'EO', type: 'number_input', category: 'Number and Algebra',
    context: ctxEO,
    question: 'What is Casey\'s total gross pay for the week, including overtime pay?',
    answer: '2509'
  },
  {
    group: 'EP', type: 'number_input', category: 'Number and Algebra',
    context: ctxEP,
    question: 'What are Riley\'s total billable hours for the week?',
    answer: '40'
  },
  {
    group: 'EP', type: 'number_input', category: 'Number and Algebra',
    context: ctxEP,
    question: 'How much more does Casey earn than Riley this week?',
    answer: '164.25'
  },
  {
    group: 'EQ', type: 'number_input', category: 'Number and Algebra',
    context: ctxEQ,
    question: 'What are Sam\'s total billable hours for the week?',
    answer: '39.5'
  },
  {
    group: 'EQ', type: 'number_input', category: 'Number and Algebra',
    context: ctxEQ,
    question: 'What is Sam\'s gross pay for the week?',
    answer: '2429.25'
  },
  {
    group: 'ER', type: 'number_input', category: 'Number and Algebra',
    context: ctxER,
    question: 'What is the total number of billable crew hours for the week across all three crew members?',
    answer: '119.5'
  },
  {
    group: 'ER', type: 'number_input', category: 'Number and Algebra',
    context: ctxER,
    question: 'What is the total amount billed to the client for the week?',
    answer: '10157.50'
  },
  {
    group: 'ES', type: 'number_input', category: 'Number and Algebra',
    context: ctxES,
    question: 'What percentage of a standard 40-hour week did Taylor work?',
    answer: '91.25'
  },
  {
    group: 'ES', type: 'number_input', category: 'Number and Algebra',
    context: ctxES,
    question: 'What is Taylor\'s gross pay for the week?',
    answer: '2171.75'
  },
  {
    group: 'ET', type: 'number_input', category: 'Number and Algebra',
    context: ctxET,
    question: 'What are Morgan\'s total billable hours across the 4-day week?',
    answer: '40.75'
  },
  {
    group: 'ET', type: 'number_input', category: 'Number and Algebra',
    context: ctxET,
    question: 'What is Morgan\'s gross pay for the week?',
    answer: '2282'
  },
  {
    group: 'EU', type: 'number_input', category: 'Number and Algebra',
    context: ctxEU,
    question: 'What are Avery\'s total billable hours for the fortnight?',
    answer: '80.75'
  },
  {
    group: 'EU', type: 'number_input', category: 'Number and Algebra',
    context: ctxEU,
    question: 'What is the difference in gross fortnightly pay between Blake and Avery?',
    answer: '99.75'
  },
  {
    group: 'EV', type: 'number_input', category: 'Number and Algebra',
    context: ctxEV,
    question: 'What is the total amount billed to the client under Structure A?',
    answer: '3060'
  },
  {
    group: 'EV', type: 'number_input', category: 'Number and Algebra',
    context: ctxEV,
    question: 'What is the total amount billed to the client under Structure B?',
    answer: '2987.50'
  },

  // ── Sets EW–FF: Standard Drinks Level 2 ─────────────────────────────────────
  {
    group: 'EW', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'Alex consumed a 330 mL can of beer (4.8% ABV) and a 200 mL glass of wine (13.5% ABV). How many standard drinks is the beer?',
    answer: '1.25'
  },
  {
    group: 'EW', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'What is Alex\'s total standard drink consumption across both drinks?',
    answer: '3.38'
  },
  {
    group: 'EX', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'Sam had two 375 mL beers (5.0% ABV each) and one 150 mL glass of wine (14.0% ABV). How many standard drinks are in the two beers combined?',
    answer: '2.96'
  },
  {
    group: 'EX', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'What is Sam\'s total standard drink consumption across all three drinks?',
    answer: '4.62'
  },
  {
    group: 'EY', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'A punch bowl contains 3 litres of fruit punch at 8.0% ABV. How many standard drinks are in the entire punch bowl?',
    answer: '18.94'
  },
  {
    group: 'EY', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'The punch is served in 250 mL cups. How many standard drinks does each cup contain?',
    answer: '1.58'
  },
  {
    group: 'EZ', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'A 570 mL pint of craft beer (6.8% ABV) and a 120 mL glass of port (18.5% ABV) are consumed. How many standard drinks is the pint of craft beer?',
    answer: '3.06'
  },
  {
    group: 'EZ', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'What is the total standard drink count for both drinks combined?',
    answer: '4.81'
  },
  {
    group: 'FA', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'Jamie consumed a 375 mL beer (5.0% ABV), a 250 mL glass of wine (14.5% ABV), and a 60 mL shot of spirit (40.0% ABV). What is Jamie\'s total standard drink consumption?',
    answer: '6.23'
  },
  {
    group: 'FA', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'The guideline is a maximum of 4 standard drinks per occasion. By how many standard drinks did Jamie exceed this limit?',
    answer: '2.23'
  },
  {
    group: 'FB', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'Jordan consumed a 285 mL beer (4.9% ABV), a 150 mL wine (14.0% ABV), and a 30 mL shot (37.5% ABV). What is Jordan\'s total standard drink consumption?',
    answer: '3.65'
  },
  {
    group: 'FB', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'What percentage of the 4 standard drink guideline did Jordan consume?',
    answer: '91.25'
  },
  {
    group: 'FC', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'Riley consumed the following over the weekend — Friday: a 375 mL beer (5.0% ABV) and a 180 mL wine (13.0% ABV). Saturday: a 500 mL beer (4.5% ABV), a 250 mL wine (12.5% ABV), and a 60 mL spirit (40.0% ABV). How many standard drinks did Riley consume on Friday?',
    answer: '3.33'
  },
  {
    group: 'FC', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'Using the same weekend scenario, how many standard drinks did Riley consume on Saturday?',
    answer: '6.14'
  },
  {
    group: 'FD', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'A Craft IPA is 330 mL at 7.4% ABV. A Session Lager is 330 mL at 3.5% ABV. How many standard drinks is the Craft IPA?',
    answer: '1.93'
  },
  {
    group: 'FD', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'If you consumed one of each beer, what is the total number of standard drinks?',
    answer: '2.84'
  },
  {
    group: 'FE', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'A standard 750 mL bottle of wine is 13.5% ABV. How many standard drinks does it contain?',
    answer: '7.99'
  },
  {
    group: 'FE', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'How many standard drinks would be in a 1.5 L magnum of the same wine?',
    answer: '15.98'
  },
  {
    group: 'FF', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'A standard beer is 375 mL at 4.9% ABV. A low-alcohol version of the same beer is 375 mL at 0.5% ABV. How many standard drinks is the standard beer?',
    answer: '1.45'
  },
  {
    group: 'FF', type: 'number_input', category: 'Number and Algebra',
    context: ctxSD,
    question: 'How many fewer standard drinks is the low-alcohol version compared to the standard beer?',
    answer: '1.30'
  },

  // ── Sets FG–FP: Pay Gap Level 2 ─────────────────────────────────────────────
  {
    group: 'FG', type: 'number_input', category: 'Number and Algebra',
    context: ctxFG,
    question: 'What is the average annual salary for female employees?',
    answer: '81000'
  },
  {
    group: 'FG', type: 'number_input', category: 'Number and Algebra',
    context: ctxFG,
    question: 'What is the gender pay gap as a percentage of the male average salary?',
    answer: '7.95'
  },
  {
    group: 'FH', type: 'number_input', category: 'Number and Algebra',
    context: ctxFH,
    question: 'What is the current annual pay gap per employee (female vs male)?',
    answer: '7500'
  },
  {
    group: 'FH', type: 'number_input', category: 'Number and Algebra',
    context: ctxFH,
    question: 'What is the total additional annual cost to raise all female salaries to the male average?',
    answer: '210000'
  },
  {
    group: 'FI', type: 'number_input', category: 'Number and Algebra',
    context: ctxFI,
    question: 'What was the gender pay gap (as a percentage of male average salary) in 2022?',
    answer: '12.98'
  },
  {
    group: 'FI', type: 'number_input', category: 'Number and Algebra',
    context: ctxFI,
    question: 'What was the gender pay gap (as a percentage of male average salary) in 2023?',
    answer: '11.11'
  },
  {
    group: 'FJ', type: 'number_input', category: 'Number and Algebra',
    context: ctxFJ,
    question: 'What is the total annual under-payment to female employees in the Finance department?',
    answer: '89600'
  },
  {
    group: 'FJ', type: 'number_input', category: 'Number and Algebra',
    context: ctxFJ,
    question: 'What is the total annual under-payment to female employees across all three departments combined?',
    answer: '279900'
  },
  {
    group: 'FK', type: 'number_input', category: 'Number and Algebra',
    context: ctxFK,
    question: 'What is the median annual salary across these ten employees?',
    answer: '63400'
  },
  {
    group: 'FK', type: 'number_input', category: 'Number and Algebra',
    context: ctxFK,
    question: 'What is the mean annual salary across these ten employees?',
    answer: '66000'
  },
  {
    group: 'FL', type: 'number_input', category: 'Number and Algebra',
    context: ctxFL,
    question: 'What is the current gender pay gap as a percentage of the male average salary?',
    answer: '8.57'
  },
  {
    group: 'FL', type: 'number_input', category: 'Number and Algebra',
    context: ctxFL,
    question: 'What is the total additional annual cost to close the pay gap completely across all female employees?',
    answer: '230400'
  },
  {
    group: 'FM', type: 'number_input', category: 'Number and Algebra',
    context: ctxFM,
    question: 'What is the total annual female wage bill across both sites?',
    answer: '3246600'
  },
  {
    group: 'FM', type: 'number_input', category: 'Number and Algebra',
    context: ctxFM,
    question: 'What is the weighted average female salary across both sites combined?',
    answer: '81165'
  },
  {
    group: 'FN', type: 'number_input', category: 'Number and Algebra',
    context: ctxFN,
    question: 'What is the target female average salary required to reduce the pay gap to 4% of the male average?',
    answer: '76800'
  },
  {
    group: 'FN', type: 'number_input', category: 'Number and Algebra',
    context: ctxFN,
    question: 'What is the required pay increase per female employee to achieve this target?',
    answer: '4800'
  },
  {
    group: 'FO', type: 'number_input', category: 'Number and Algebra',
    context: ctxFO,
    question: 'What is the gender pay gap (as a percentage of male average salary) in the Construction industry?',
    answer: '19.39'
  },
  {
    group: 'FO', type: 'number_input', category: 'Number and Algebra',
    context: ctxFO,
    question: 'How many percentage points larger is the Construction pay gap compared to Education?',
    answer: '17.17'
  },
  {
    group: 'FP', type: 'number_input', category: 'Number and Algebra',
    context: ctxFP,
    question: 'What is the total annual bonus paid to all female employees?',
    answer: '147000'
  },
  {
    group: 'FP', type: 'number_input', category: 'Number and Algebra',
    context: ctxFP,
    question: 'What is the total annual bonus gap between male and female employees across the company?',
    answer: '154000'
  },

  // ── Sets FQ–FZ: Travel & Commute Level 2 ─────────────────────────────────────
  {
    group: 'FQ', type: 'number_input', category: 'Number and Algebra',
    context: ctxFQ,
    question: 'What is the total one-way commute time in minutes?',
    answer: '70'
  },
  {
    group: 'FQ', type: 'number_input', category: 'Number and Algebra',
    context: ctxFQ,
    question: 'What is the total weekly commute cost for return trips, 5 days a week?',
    answer: '73'
  },
  {
    group: 'FR', type: 'number_input', category: 'Number and Algebra',
    context: ctxFR,
    question: 'How many extra minutes per week (return trips, 5 days) does Route B take compared to Route A?',
    answer: '160'
  },
  {
    group: 'FR', type: 'number_input', category: 'Number and Algebra',
    context: ctxFR,
    question: 'How much cheaper is Route B compared to Route A over a 5-day working week (return trips)?',
    answer: '52'
  },
  {
    group: 'FS', type: 'number_input', category: 'Number and Algebra',
    context: ctxFS,
    question: 'What is the total scheduled commute time in minutes, with no delays?',
    answer: '77'
  },
  {
    group: 'FS', type: 'number_input', category: 'Number and Algebra',
    context: ctxFS,
    question: 'What is the actual commute time in minutes today, including delays?',
    answer: '97'
  },
  {
    group: 'FT', type: 'number_input', category: 'Number and Algebra',
    context: ctxFT,
    question: 'What is the cost per minute for the car commute, based on the weekly return trip total? (Round to 2 decimal places.)',
    answer: '0.24'
  },
  {
    group: 'FT', type: 'number_input', category: 'Number and Algebra',
    context: ctxFT,
    question: 'How much is saved by choosing the train over the car across a 4-week period?',
    answer: '118'
  },
  {
    group: 'FU', type: 'number_input', category: 'Number and Algebra',
    context: ctxFU,
    question: 'What is the average speed of the drive to the station in km/h? (Round to 2 decimal places.)',
    answer: '26.67'
  },
  {
    group: 'FU', type: 'number_input', category: 'Number and Algebra',
    context: ctxFU,
    question: 'What is the average speed of the train in km/h? (Round to 2 decimal places.)',
    answer: '43.64'
  },
  {
    group: 'FV', type: 'number_input', category: 'Number and Algebra',
    context: ctxFV,
    question: 'How many hours per week does Riley spend commuting in total (both ways, 5 days)?',
    answer: '9.5'
  },
  {
    group: 'FV', type: 'number_input', category: 'Number and Algebra',
    context: ctxFV,
    question: 'What percentage of a 38-hour working week does Riley spend commuting?',
    answer: '25'
  },
  {
    group: 'FW', type: 'number_input', category: 'Number and Algebra',
    context: ctxFW,
    question: 'What is the current annual commute cost?',
    answer: '3128'
  },
  {
    group: 'FW', type: 'number_input', category: 'Number and Algebra',
    context: ctxFW,
    question: 'How much would be saved annually by moving closer to work?',
    answer: '1564'
  },
  {
    group: 'FX', type: 'number_input', category: 'Number and Algebra',
    context: ctxFX,
    question: 'How many litres of fuel does Maya use for one return commute trip?',
    answer: '5.78'
  },
  {
    group: 'FX', type: 'number_input', category: 'Number and Algebra',
    context: ctxFX,
    question: 'What is Maya\'s daily fuel cost for commuting?',
    answer: '10.52'
  },
  {
    group: 'FY', type: 'number_input', category: 'Number and Algebra',
    context: ctxFY,
    question: 'How many hours per year does Blake currently spend commuting (going to the office 3 days per week)?',
    answer: '259.2'
  },
  {
    group: 'FY', type: 'number_input', category: 'Number and Algebra',
    context: ctxFY,
    question: 'How many commuting hours per year would Blake save compared to going in 5 days a week?',
    answer: '172.8'
  },
  {
    group: 'FZ', type: 'number_input', category: 'Number and Algebra',
    context: ctxFZ,
    question: 'What is Morgan\'s total weekly commute time in minutes (return trips, all 5 days)?',
    answer: '296'
  },
  {
    group: 'FZ', type: 'number_input', category: 'Number and Algebra',
    context: ctxFZ,
    question: 'How many extra minutes per week does Morgan spend commuting compared to driving every day?',
    answer: '76'
  },
...
const units = {
  ...
  EL: ['m³', null],
  // Timesheets Level 2
  EM: ['h', '$'], EN: ['h', '$'], EO: ['h', '$'], EP: ['h', '$'], EQ: ['h', '$'],
  ER: ['h', '$'], ES: ['%', '$'], ET: ['h', '$'], EU: ['h', '$'], EV: ['$', '$'],
  // Standard Drinks Level 2
  EW: [null, null], EX: [null, null], EY: [null, null], EZ: [null, null],
  FA: [null, null], FB: [null, '%'], FC: [null, null], FD: [null, null],
  FE: [null, null], FF: [null, null],
  // Pay Gap Level 2
  FG: ['$', '%'], FH: ['$', '$'], FI: ['%', '%'], FJ: ['$', '$'],
  FK: ['$', '$'], FL: ['%', '$'], FM: ['$', '$'], FN: ['$', '$'],
  FO: ['%', '%'], FP: ['$', '$'],
  // Travel & Commute Level 2
...
const methods = {
  ...
  // ── Timesheets Level 2 methods ────────────────────────────────────────────────
  EM: [
    `Mon: 8 h 45 min − 45 min = 8.00 h\nTue: 9 h 15 min − 30 min = 8.75 h\nWed: 8 h 15 min − 45 min = 7.50 h\nThu: 7 h 45 min − 30 min = 7.25 h\nFri: 8 h 30 min − 45 min = 7.75 h\nTotal: 8.00 + 8.75 + 7.50 + 7.25 + 7.75 = 39.25 h`,
    `39.25 h × $54.00/hr = $2,119.50`,
  ],
  EN: [
    `Mon + Tue + Wed: 8.00 + 7.50 + 8.25 = 23.75 h`,
    `Site A pay: 23.75 h × $58.00 = $1,377.50\nSite B hours: 8.00 + 7.75 = 15.75 h\nSite B pay: 15.75 h × $63.00 = $992.25\nTotal: $1,377.50 + $992.25 = $2,369.75`,
  ],
  EO: [
    `Mon: 10.0 − 8 = 2.0 h OT\nTue: 8.0 − 8 = 0 h OT\nWed: 9.5 − 8 = 1.5 h OT\nThu: 8.0 − 8 = 0 h OT\nFri: 10.0 − 8 = 2.0 h OT\nTotal OT: 2.0 + 1.5 + 2.0 = 5.5 h`,
    `Standard pay: 40 h × $52.00 = $2,080.00\nOT rate: $52.00 × 1.5 = $78.00/hr\nOT pay: 5.5 h × $78.00 = $429.00\nTotal: $2,080.00 + $429.00 = $2,509.00`,
  ],
  EP: [
    `Riley: 8.50 + 7.75 + 8.00 + 8.25 + 7.50 = 40.00 h`,
    `Riley: 40.00 h × $56.00 = $2,240.00\nCasey: (7.75 + 8.25 + 8.50 + 7.50 + 8.75) h × $59.00\n     = 40.75 h × $59.00 = $2,404.25\nDifference: $2,404.25 − $2,240.00 = $164.25`,
  ],
  EQ: [
    `Mon: 8 h 45 min − 45 min = 8.00 h\nTue: 9 h 30 min − 60 min = 8.50 h\nWed: 7 h 15 min − 30 min = 6.75 h\nThu: 8 h 45 min − 45 min = 8.00 h\nFri: 9 h 15 min − 60 min = 8.25 h\nTotal: 8.00 + 8.50 + 6.75 + 8.00 + 8.25 = 39.50 h`,
    `39.50 h × $61.50/hr = $2,429.25`,
  ],
  ER: [
    `38.50 + 41.25 + 39.75 = 119.50 h`,
    `119.50 h × $85.00/hr = $10,157.50`,
  ],
  ES: [
    `Total hours: 7.75 + 8.00 + 7.25 + 8.25 + 5.25 = 36.50 h\n36.50 ÷ 40 × 100 = 91.25%`,
    `36.50 h × $59.50/hr = $2,171.75`,
  ],
  ET: [
    `Mon: 11 h 30 min − 60 min = 10.50 h\nTue: 11 h 30 min − 60 min = 10.50 h\nWed: 11 h 30 min − 75 min = 10.25 h\nThu: 10 h 30 min − 60 min = 9.50 h\nTotal: 10.50 + 10.50 + 10.25 + 9.50 = 40.75 h`,
    `40.75 h × $56.00/hr = $2,282.00`,
  ],
  EU: [
    `Avery: 39.25 + 41.50 = 80.75 h`,
    `Avery: 80.75 h × $54.00 = $4,360.50\nBlake: (38.00 + 40.25) h × $57.00 = 78.25 × $57.00 = $4,460.25\nDifference: $4,460.25 − $4,360.50 = $99.75`,
  ],
  EV: [
    `Structure A: 42.5 h × $72.00 = $3,060.00`,
    `Structure B:\n  First 35 h:  35 × $65.00 = $2,275.00\n  Next 7.5 h:  7.5 × $95.00 = $712.50\n  Total: $2,275.00 + $712.50 = $2,987.50`,
  ],

  // ── Standard Drinks Level 2 methods ─────────────────────────────────────────
  EW: [
    `Beer: 330 × 4.8 × 0.000789 = 1.25 SD`,
    `Wine: 200 × 13.5 × 0.000789 = 2.13 SD\nTotal: 1.25 + 2.13 = 3.38 SD`,
  ],
  EX: [
    `Each beer: 375 × 5.0 × 0.000789 = 1.48 SD\nTwo beers: 1.48 × 2 = 2.96 SD`,
    `Wine: 150 × 14.0 × 0.000789 = 1.66 SD\nTotal: 2.96 + 1.66 = 4.62 SD`,
  ],
  EY: [
    `3,000 × 8.0 × 0.000789 = 18.94 SD`,
    `Each cup: 250 × 8.0 × 0.000789 = 1.58 SD\n(Or: 18.94 SD ÷ 12 cups = 1.58 SD)`,
  ],
  EZ: [
    `Craft beer: 570 × 6.8 × 0.000789 = 3.06 SD`,
    `Port: 120 × 18.5 × 0.000789 = 1.75 SD\nTotal: 3.06 + 1.75 = 4.81 SD`,
  ],
  FA: [
    `Beer:  375 × 5.0  × 0.000789 = 1.48 SD\nWine:  250 × 14.5 × 0.000789 = 2.86 SD\nShot:   60 × 40.0 × 0.000789 = 1.89 SD\nTotal: 1.48 + 2.86 + 1.89 = 6.23 SD`,
    `6.23 − 4.00 = 2.23 SD over the guideline`,
  ],
  FB: [
    `Beer:  285 × 4.9  × 0.000789 = 1.10 SD\nWine:  150 × 14.0 × 0.000789 = 1.66 SD\nShot:   30 × 37.5 × 0.000789 = 0.89 SD\nTotal: 1.10 + 1.66 + 0.89 = 3.65 SD`,
    `3.65 ÷ 4 × 100 = 91.25%`,
  ],
  FC: [
    `Beer: 375 × 5.0 × 0.000789 = 1.48 SD\nWine: 180 × 13.0 × 0.000789 = 1.85 SD\nFriday total: 1.48 + 1.85 = 3.33 SD`,
    `Beer:   500 × 4.5  × 0.000789 = 1.78 SD\nWine:   250 × 12.5 × 0.000789 = 2.47 SD\nSpirit:  60 × 40.0 × 0.000789 = 1.89 SD\nSaturday total: 1.78 + 2.47 + 1.89 = 6.14 SD`,
  ],
  FD: [
    `Craft IPA: 330 × 7.4 × 0.000789 = 1.93 SD`,
    `Session Lager: 330 × 3.5 × 0.000789 = 0.91 SD\nTotal: 1.93 + 0.91 = 2.84 SD`,
  ],
  FE: [
    `750 × 13.5 × 0.000789 = 7.99 SD`,
    `1,500 × 13.5 × 0.000789 = 15.98 SD\n(Or: 7.99 × 2 = 15.98 SD)`,
  ],
  FF: [
    `375 × 4.9 × 0.000789 = 1.45 SD`,
    `Low-alc: 375 × 0.5 × 0.000789 = 0.15 SD\nDifference: 1.45 − 0.15 = 1.30 SD`,
  ],

  // ── Pay Gap Level 2 methods ──────────────────────────────────────────────────
  FG: [
    `$3,645,000 ÷ 45 = $81,000`,
    `Male avg: $3,344,000 ÷ 38 = $88,000\nGap: ($88,000 − $81,000) ÷ $88,000 × 100 = 7.95%`,
  ],
  FH: [
    `$82,000 − $74,500 = $7,500 per employee`,
    `$7,500 × 28 employees = $210,000`,
  ],
  FI: [
    `2022: ($78,600 − $68,400) ÷ $78,600 × 100\n= $10,200 ÷ $78,600 × 100 = 12.98%`,
    `2023: ($80,100 − $71,200) ÷ $80,100 × 100\n= $8,900 ÷ $80,100 × 100 = 11.11%`,
  ],
  FJ: [
    `Finance: ($97,600 − $91,200) × 14 = $6,400 × 14 = $89,600`,
    `Operations: ($81,400 − $74,800) × 23 = $6,600 × 23 = $151,800\nHR: ($72,000 − $68,500) × 11 = $3,500 × 11 = $38,500\nTotal: $89,600 + $151,800 + $38,500 = $279,900`,
  ],
  FK: [
    `Median = average of 5th and 6th values (10 total)\n= ($63,400 + $63,400) ÷ 2 = $63,400`,
    `Sum: $52,000 + $54,500 + $58,000 + $61,200 + $63,400\n   + $63,400 + $67,800 + $72,000 + $76,500 + $91,200\n= $660,000\nMean: $660,000 ÷ 10 = $66,000`,
  ],
  FL: [
    `($84,000 − $76,800) ÷ $84,000 × 100 = $7,200 ÷ $84,000 × 100 = 8.57%`,
    `$7,200 × 32 employees = $230,400`,
  ],
  FM: [
    `Melbourne: 22 × $79,500 = $1,749,000\nSydney:    18 × $83,200 = $1,497,600\nTotal: $1,749,000 + $1,497,600 = $3,246,600`,
    `$3,246,600 ÷ (22 + 18) = $3,246,600 ÷ 40 = $81,165`,
  ],
  FN: [
    `Target = male avg × (1 − 0.04) = $80,000 × 0.96 = $76,800`,
    `$76,800 − $72,000 = $4,800 per employee`,
  ],
  FO: [
    `Construction: ($84,600 − $68,200) ÷ $84,600 × 100\n= $16,400 ÷ $84,600 × 100 = 19.39%`,
    `Education: ($81,200 − $79,400) ÷ $81,200 × 100\n= $1,800 ÷ $81,200 × 100 = 2.22%\nDifference: 19.39% − 2.22% = 17.17 percentage points`,
  ],
  FP: [
    `$4,200 × 35 = $147,000`,
    `Male total: $8,600 × 35 = $301,000\nGap: $301,000 − $147,000 = $154,000`,
  ],

  // ── Travel & Commute Level 2 methods ─────────────────────────────────────────
  FQ: [
    `12 + 34 + 18 + 6 = 70 min`,
    `Paid legs each way: $4.80 + $2.50 = $7.30\nReturn trip: $7.30 × 2 = $14.60/day\nWeekly (5 days): $14.60 × 5 = $73.00`,
  ],
  FR: [
    `Extra per one-way trip: 68 − 52 = 16 min\nReturn per day: 16 × 2 = 32 min\nWeekly (5 days): 32 × 5 = 160 min`,
    `Daily saving (one way): $8.40 − $3.20 = $5.20\nReturn saving per day: $5.20 × 2 = $10.40\nWeekly: $10.40 × 5 = $52.00`,
  ],
  FS: [
    `22 + 5 + 41 + 9 = 77 min`,
    `77 + 8 + 12 = 97 min`,
  ...
  FT: [
    `Weekly car minutes: 28 min × 2 ways × 5 days = 280 min\n$67.50 ÷ 280 = $0.24 per min`,
    `Weekly saving: $67.50 − $38.00 = $29.50\n4-week saving: $29.50 × 4 = $118.00`,
  ],
  FU: [
    `Speed = Distance ÷ Time\n= 8 km ÷ (18 ÷ 60) h = 8 ÷ 0.3 h = 26.67 km/h`,
    `Speed = 16 km ÷ (22 ÷ 60) h = 16 ÷ 0.3667 h = 43.64 km/h`,
  ],
  FV: [
    `57 min × 2 ways × 5 days = 570 min\n570 ÷ 60 = 9.5 h`,
    `9.5 h ÷ 38 h × 100 = 25%`,
  ],
  FW: [
    `$13.60 × 230 = $3,128.00`,
    `Saving per day: $13.60 − $6.80 = $6.80\nAnnual saving: $6.80 × 230 = $1,564.00`,
  ],
  FX: [
    `Return distance: 34 × 2 = 68 km\nFuel: 68 × 8.5 ÷ 100 = 5.78 L`,
    `5.78 L × $1.82 = $10.52`,
  ],
  FY: [
    `Office days/year: 3 × 48 = 144 days\nCommute time: 144 × 54 min × 2 = 15,552 min\n15,552 ÷ 60 = 259.2 h`,
    `WFH days saved/year: 2 × 48 = 96 days\nTime saved: 96 × 54 × 2 ÷ 60 = 172.8 h`,
  ],
  FZ: [
